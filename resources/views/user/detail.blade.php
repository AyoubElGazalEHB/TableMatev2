...
<head>
   <meta charset="UTF-8">
	...
	<meta name="description" content="Star Restaurants Helps you Discover The Perfect Balance
	Of Hospitality, Luxury And
	Comfort.">
	<title>Z Restaurants</title>
	...
	<link rel="stylesheet" href="../assets/css/global-header.css">
	<link rel="stylesheet" href="../assets/css/global-footer.css">
	<link rel="stylesheet" href="../assets/css/tables-and-suites.css">
	<link rel="shortcut icon" href="../assets/img/favicon.webp" type="image/x-icon">
		...
		<div class="footer-container">
			<nav class="footer-nav">
				<div class="footer-description">
					<h3 class="footer-description-title">Z Restaurants</h3>
